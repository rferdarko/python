...
mylist = [     # Start of list
    {  # dictionary 0
        'a': [99,88,77,66,55,44,33,22],   # key: value list
        'b': 'X',                            # key : value
        11 : [21,22,23,24,25,26]             # key:value list
},     # End of dictionary 0
{      # dictionary 1
...
print(mylist[0][11][3])   # Prints from list, dictionary '0' key 'a' value '3'
print(mylist[1]['b'])   # Prints from list, dictionary '1' key 'b'
print(mylist[1]['c'][1])   # Prints from list, dictionary '0' key 'c' value '4'
